...
import com.codingbad.project.uber.uberApp.entities.Rating;
...
import com.codingbad.project.uber.uberApp.repositories.RatingRepository;
import com.codingbad.project.uber.uberApp.repositories.RiderRepository;
import com.codingbad.project.uber.uberApp.services.RatingService;
...
public class RatingServiceImpl implements RatingService {
    ...
    public DriverDto rateDriver(Ride ride, Integer rating) {
        ...
        Rating ratingObj = ratingRepository.findByRide(ride).orElseThrow(()-> new ResourceNotFoundException("Ride not found "+ride.getId()));
    ...
    public void createNewRating(Ride ride) {
        Rating rating =Rating.builder().rider(ride.getRider())
